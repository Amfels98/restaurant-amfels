 ...
 *{margin:0;box-sizing:border-box;}
 ...
 .sec{text-align:center;font-family:'Playfair Display',serif;font-weight:700;font-size:19px;letter-spacing:.06em;text-transform:uppercase;color:var(--bord);margin:6mm 0 3mm;}
 .sec.first{margin-top:2mm;}
 .dish{text-align:center;margin-bottom:3.4mm;break-inside:avoid;}
 .dn{font-family:'Oswald',sans-serif;font-weight:600;font-size:12.5px;letter-spacing:.01em;color:var(--ink);}
 ...
 .dd{font-size:10px;line-height:1.35;color:var(--muted);margin-top:.4mm;}
 .sz{font-size:10.5px;color:var(--ink);margin-top:.6mm;}
 .sz b{color:var(--bord);}
 /* Getraenke */
 ...
 .gcol{flex:1;}
 .gh{text-align:center;font-family:'Playfair Display',serif;font-weight:700;font-size:14px;letter-spacing:.05em;text-transform:uppercase;color:var(--bord);margin:0 0 2mm;}
 .gh.mt{margin-top:6mm;}
 .gitem{text-align:center;font-size:10.5px;line-height:1.5;color:var(--ink);}
 .gitem .u{color:var(--muted);font-size:8.5px;}
 .gsubh{text-align:center;font-weight:700;font-size:10px;color:var(--muted);margin:1.5mm 0 .5mm;}
...
p1=('<div class="sec first">Vorspeise</div>'
 ...
 +dish('Gem&uuml;seteller Vegetaria','20,90','Paprika &middot; Zucchini &middot; Champignons &middot; Ofenkartoffel mit Sauerrahm')
 ...
 +steak_nogf('Pfanne &bdquo;Am Fels&ldquo;','Steakfleischstreifen &middot; feurige Paprika-Chili-Salsa &middot; Champignons &middot; Butterreis',[('200g','23,90'),('300g','29,90'),('400g','35,90')]))
...
p2=('<div class="sec first">Hauptspeise</div>'
 ...
 +dish('Schnitzel Champignon','19,90','vom H&auml;hnchen &middot; paniert &middot; Champignonsauce')
 +dish('Pfeffertopf','20,90','Schweinefilet &middot; Pfeffersauce &middot; Bratkartoffeln')
 +dish('Grill Teller','21,90','Hacksteak &middot; R&uuml;ckensteak &middot; Raznjici &middot; Cevapcici &middot; Pommes &middot; Djuwetschreis'))

# ---- Seite 3 ----
p3=('<div class="sec first">Hauptspeise</div>'
 ...
 +dish('Hacksteak Hirten','19,90','gef&uuml;llt mit Schafsk&auml;se &middot; Pommes &middot; Djuwetschreis')
 +'<div class="sec">Desserts</div>'
 +dish('Lava Cake','8,90','Schokoladen-Souffl&eacute; mit Vanilleeis und Sahne')
 +dish('Cr&egrave;me br&ucirc;l&eacute;e','6,90','mit karamellisierter Zuckerschicht'))
...
gL=('<div class="gh">Aperitifs</div>'
 +gi('Aperol Spritz','0,2l','7,90')+gi('Lillet Berry','0,2l','7,90')+gi('Gin Tonic','0,25l','9,90')+gi('Glas Sekt','0,1l','4,50')
 +'<div class="gh mt">Alkoholfreie Getr&auml;nke</div>'
 +gi('Coca-Cola','0,3l','3,50')+gi('Fanta','0,3l','3,50')+gi('Sprite','0,3l','3,50')+gi('Fassbrause','0,33l','3,80')
 +gi('Bitter Lemon','0,2l','3,00')+gi('Eistee Pfirsich','0,33l','3,90')+gi('Cola Zero','0,33l','3,90')+gi('Wasser','0,75l','6,70')
 +gi('Apfelschorle','0,33l','3,90')+gi('Rhabarberlimo','0,33l','3,90')
 +'<div class="gh mt">Wein</div>'
 +'<div class="gsubh">Wei&szlig;wein</div>'
 +gi('Pinot Grigio, trocken','0,2l','6,50')+gi('Verdejo Rueda, halbtrocken','0,2l','7,30')+gi('Semidulce, lieblich','0,2l','7,70')
 +'<div class="gsubh">Rotwein</div>'
 +gi('Merlot, trocken','0,2l','6,50')+gi('Casa Carmela, halbtrocken','0,2l','7,00')+gi('Kadarka, lieblich','0,2l','6,90'))
gR=('<div class="gh">Bier</div>'
 +gi('Fr&uuml;h K&ouml;lsch','0,3l','3,30')+gi('Bergisches Landbier','0,3l','3,40')+gi('Erzquell Pils','0,3l','3,30')
 +gi('Paulaner Weizen','0,5l','5,60')+gi('Landbier alkoholfrei','0,33l','3,80')+gi('K&ouml;lsch alkoholfrei','0,33l','3,60')+gi('Weizen alkoholfrei','0,5l','5,60')
 +'<div class="gh mt">Spirituosen</div>'
 +gi('Wodka','2cl','2,50')+gi('Julishka','2cl','2,50')+gi('Ramazzotti','4cl','4,50')+gi('J&auml;germeister','2cl','2,50')
 +gi('Williams-Birne','2cl','3,20')+gi('Slivovic','2cl','2,50')+gi('Vi&scaron;njevac (Kirschlik&ouml;r)','4cl','4,50')+gi('Baileys','4cl','4,50')
...
BODY=page(p1,head=True)+page(p2)+page(p3)+page(p4)
